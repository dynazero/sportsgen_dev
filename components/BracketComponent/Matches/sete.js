...
const SetE = ({ participantsCount, bracketFS, categorykey, categorySet, tournamentInfo, reParticipants }) => {
  ...
  const scores = {
    ...
    matchJ: { player1: '0', player2: '0' },
    matchK: { player1: '0', player2: '0' },
    matchL: { player1: '0', player2: '0' },
    matchM: { player1: '0', player2: '0' },
    matchN: { player1: '0', player2: '0' },
    matchO: { player1: '0', player2: '0' },
    matchP: { player1: '0', player2: '0' },
    matchQ: { player1: '0', player2: '0' },
  };
  ...
  const initialMatches = {
    ...
    // },
    matchA: { participant1: reParticipants.participant1.name, participant2: reParticipants.participant2.name, winner: matchWinners.matchA, loser: matchLosers.matchA, score: scores.matchA, status: 'open' },
    matchB: { participant1: reParticipants.participant3.name, participant2: reParticipants.participant4.name, winner: matchWinners.matchB, loser: matchLosers.matchB, score: scores.matchB, status: 'open' },
    matchC: { participant1: reParticipants.participant6.name, participant2: reParticipants.participant7.name, winner: matchWinners.matchC, loser: matchLosers.matchC, score: scores.matchC, status: 'open' },
    matchD: { participant1: reParticipants.participant9.name, participant2: reParticipants.participant10.name, winner: matchWinners.matchD, loser: matchLosers.matchD, score: scores.matchD, status: 'open' },
    matchE: { participant1: matchWinners.matchA, participant2: reParticipants.participant5.name, winner: matchWinners.matchE, loser: matchLosers.matchE, score: scores.matchE, status: 'close' },
    matchF: { participant1: matchWinners.matchB, participant2: reParticipants.participant8.name, winner: matchWinners.matchF, loser: matchLosers.matchF, score: scores.matchF, status: 'close' },
    matchG: { participant1: matchWinners.matchE, participant2: matchWinners.matchC, winner: matchWinners.matchG, loser: matchLosers.matchG, score: scores.matchG, status: 'close' },
    matchH: { participant1: matchWinners.matchF, participant2: matchWinners.matchD, winner: matchWinners.matchH, loser: matchLosers.matchH, score: scores.matchH, status: 'close' },
    matchI: { participant1: matchLosers.matchA, participant2: matchLosers.matchB, winner: matchWinners.matchI, loser: matchLosers.matchI, score: scores.matchI, status: 'close' },
    matchJ: { participant1: matchLosers.matchC, participant2: matchLosers.matchD, winner: matchWinners.matchD, loser: matchLosers.matchJ, score: scores.matchJ, status: 'close' },
    matchK: { participant1: matchLosers.matchE, participant2: matchWinners.matchI, winner: matchWinners.matchK, loser: matchLosers.matchK, score: scores.matchK, status: 'close' },
    matchL: { participant1: matchLosers.matchF, participant2: matchWinners.matchJ, winner: matchWinners.matchL, loser: matchLosers.matchL, score: scores.matchL, status: 'close' },
    matchM: { participant1: matchLosers.matchG, participant2: matchWinners.matchK, winner: matchWinners.matchM, loser: matchLosers.matchM, score: scores.matchM, status: 'close' },
    matchN: { participant1: matchLosers.matchH, participant2: matchWinners.matchL, winner: matchWinners.matchN, loser: matchLosers.matchN, score: scores.matchN, status: 'close' },
    matchO: { participant1: matchWinners.matchG, participant2: matchWinners.matchH, winner: matchWinners.matchO, loser: matchLosers.matchO, score: scores.matchO, status: 'close' },
    matchP: { participant1: matchWinners.matchM, participant2: matchWinners.matchN, winner: matchWinners.matchP, loser: matchLosers.matchP, score: scores.matchP, status: 'close' },
    matchQ: { participant1: matchLosers.matchO, participant2: matchWinners.matchP, winner: matchWinners.matchQ, loser: matchLosers.matchQ, score: scores.matchQ, status: 'close' },
    champion: { winner: matchWinners.matchO },
    secondplace: { winner: matchWinners.matchQ },
    thirdplace: { winner: matchLosers.matchQ }
  };

  const bracketfs = bracketFS;
  ...
  const updateParticipants = (matchKey, matchWinner, matchLoser) => {
    switch (matchKey) {
      case 'matchA':
      ...
      case 'matchO':
        for (let key in reParticipants) {
          if (reParticipants[key].name === matchWinner) {
  ...
  // console.log('reParticipants', reParticipants);
  ...
  return (
    dataLoaded ?
      <>
        <div className={`d-flex justify-content-start ${!bracketFS ? styles.rowWidth : styles.rowWidthFS}`}>
