...
import styles from './setdelta.module.css'
              ...
              <tr >
                ...
                <td className={`${styles.repbracketToptoBot}`}>
                  <svg className={`${styles.showSVG}`} height="100" width="100">
                    <path d="M102 25 H45 V70.5 H0" id="" fill="transparent" stroke="rgb(233, 236, 239)" strokeWidth="1"></path>
                  </svg>
                </td>
              ...
              <tr >
                ...
                <td className={`${styles.matchBelowBracket}`}>
                  <svg className={`${styles.showSVG}`} height="70" width="50">
                    <path d="M60 0 H30 V53.5 H0" id="" fill="transparent" stroke="rgb(233, 236, 239)" strokeWidth="1"></path>
                  </svg>
                </td>
              </tr>
            </tbody>
